...
var ran = Math.floor((Math.random()*quick_draw_data_set.length)+1);
console.log(quick_draw_data_set[ran]);
var sketch1 = quick_draw_data_set[ran];
document.getElementById("STBD").innerHTML = "Sketch To Be Drawn : "+sketch1;
...
function update_canvas()
{
    ...
    ran = Math.floor((Math.random()*quick_draw_data_set.length)+1)
    console.log(quick_draw_data_set[ran]);
    sketch1 = quick_draw_data_set[ran];
    document.getElementById("STBD").innerHTML = "Sketch To Be Drawn : "+sketch1;
}